...
# Form implementation generated from reading ui file 'fifthbox.ui'
#
...
class Ui_Box1_Window(object):
    ...
    def receive_data(self):
        box5Data = dataSender.send_data()[4]
        ...
        abnormal = False
        for i in range(len(box5Data)):
            label_list[i].setText(
                "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">" + self.labels[
                    i] + ':' + str(
                    box5Data[i]) + "</span></p></body></html>")
            if (box5Data[i] > self.pass_intervals[i][0]) and (box5Data[i] < self.pass_intervals[i][1]):
    ...
    def retranslateUi(self, Box1_Window):
        ...
        self.label_4.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:60pt; font-weight:792;\">05</span><span style=\" font-size:30pt; font-weight:96;\">号 贮运箱</span></p></body></html>"))
