...
# Form implementation generated from reading ui file 'thirdbox.ui'
#
...
"color: rgb(0, 0, 0);")
    ...
    def receive_data(self):
        box3Data = dataSender.send_data()[2]
        ...
        abnormal = False
        for i in range(len(box3Data)):
            label_list[i].setText(
                "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">" + self.labels[
                    i] + ':' + str(
                    box3Data[i]) + "</span></p></body></html>")
            if (box3Data[i] > self.pass_intervals[i][0]) and (box3Data[i] < self.pass_intervals[i][1]):
    ...
    def retranslateUi(self, Box1_Window):
        ...
        self.label_4.setText(_translate("Box1_Window", "<html><head/><body><p><span style=\" font-size:60pt; font-weight:792;\">03</span><span style=\" font-size:30pt; font-weight:96;\">号 贮运箱</span></p></body></html>"))
