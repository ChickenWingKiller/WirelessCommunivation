...
# Form implementation generated from reading ui file 'firstbox.ui'
#
...
class Ui_Box1_Window(object):
    ...
    def receive_data(self):
        box1Data = dataSender.send_data()[0]
        ...
        abnormal = False
        for i in range(len(box1Data)):
            label_list[i].setText(
                "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">" + self.labels[i] + ':' + str(
                    box1Data[i]) + "</span></p></body></html>")
            #参数正常
            if (box1Data[i] > self.pass_intervals[i][0]) and (box1Data[i] < self.pass_intervals[i][1]):
    ...
    def retranslateUi(self, Box1_Window):
        ...
        self.label_2.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:24pt; font-weight:600; color:#ffffff;\">贮运设备环境参数监测显示系统</span></p></body></html>"))
        self.label_3.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:13pt; font-weight:200; color:#ffffff;\">(获取系统时间中...)</span></p></body></html>"))
        self.label_4.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:60pt; font-weight:1000;\">01</span><span style=\" font-size:30pt; font-weight:100;\">号 贮运箱</span></p></body></html>"))
        self.label_6.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">箱外压力：</span></p></body></html>"))
        self.label_11.setText(_translate("Box1_Window",
                                         "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">箱内压力：</span></p></body></html>"))
        self.label_7.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">氮气浓度：</span></p></body></html>"))
        self.label_12.setText(_translate("Box1_Window",
                                         "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">电池电量：</span></p></body></html>"))
        self.label_9.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">箱内外压力差（倍数）：</span></p></body></html>"))
        self.label_8.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">湿度：</span></p></body></html>"))
        self.label_10.setText(_translate("Box1_Window",
                                         "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">四氧化二氮浓度：</span></p></body></html>"))
        self.label_13.setText(_translate("Box1_Window",
                                         "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">一甲基浓度：</span></p></body></html>"))
        self.label_5.setText(_translate("Box1_Window",
                                        "<html><head/><body><p><span style=\" font-size:20pt; font-weight:600;\">温度：</span></p></body></html>"))
        self.pushButton.setText(_translate("Box1_Window", "返回"))
        self.label_14.setText(_translate("Box1_Window",
                                         "<html><head/><body><p><span style=\" font-size:48pt; font-weight:600; color:#ffffff;\">运行正常</span></p></body></html>"))
